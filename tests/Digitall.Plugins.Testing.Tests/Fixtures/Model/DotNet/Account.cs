...
namespace Digitall.Plugins.Testing.Tests.Fixtures
{
	/// <inheritdoc />
	/// <summary>
	...
	public partial class Account : Entity, INotifyPropertyChanging, INotifyPropertyChanged
    {
		...
		public System.Collections.Generic.IEnumerable<Annotation> AccountAnnotation
		{
			[DebuggerNonUserCode]
			get
			{
		...
		public System.Collections.Generic.IEnumerable<Plugins.Testing.Tests.Fixtures.Account> AccountMasterAccount
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("account_master_account", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("AccountMasterAccount");
				this.SetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("account_master_account", null, value);
		...
		public System.Collections.Generic.IEnumerable<Plugins.Testing.Tests.Fixtures.Account> AccountParentAccount
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("account_parent_account", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("AccountParentAccount");
				this.SetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("account_parent_account", null, value);
		...
		public System.Collections.Generic.IEnumerable<Plugins.Testing.Tests.Fixtures.Account> MsaAccountManagingpartner
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("msa_account_managingpartner", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("MsaAccountManagingpartner");
				this.SetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("msa_account_managingpartner", null, value);
        ...
        public static Plugins.Testing.Tests.Fixtures.Account Retrieve(IOrganizationService service, Guid id)
        {
            return Retrieve(service,id, new ColumnSet(true));
        }

        public static Plugins.Testing.Tests.Fixtures.Account Retrieve(IOrganizationService service, Guid id, ColumnSet columnSet)
        {
            return service.Retrieve("account", id, columnSet).ToEntity<Plugins.Testing.Tests.Fixtures.Account>();
        }

        public Plugins.Testing.Tests.Fixtures.Account GetChangedEntity()
        {
            if (_trackChanges)
            {
                ...
                return new  Plugins.Testing.Tests.Fixtures.Account(Id) {Attributes = attr };
            }
            return this;
        }
        #endregion
	...
	{
		public IQueryable<Plugins.Testing.Tests.Fixtures.Account> AccountSet
		{
			get
			{
				return CreateQuery<Plugins.Testing.Tests.Fixtures.Account>();
			}
		}
	}
	#endregion
