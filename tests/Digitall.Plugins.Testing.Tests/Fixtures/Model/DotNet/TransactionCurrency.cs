...
namespace Digitall.Plugins.Testing.Tests.Fixtures
{
	...
	public partial class TransactionCurrency : Entity, INotifyPropertyChanging, INotifyPropertyChanged
    {
		...
		public System.Collections.Generic.IEnumerable<Plugins.Testing.Tests.Fixtures.Account> TransactioncurrencyAccount
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("transactioncurrency_account", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("TransactioncurrencyAccount");
				this.SetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("transactioncurrency_account", null, value);
