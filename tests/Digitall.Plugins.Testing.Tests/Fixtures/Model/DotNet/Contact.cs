...
namespace Digitall.Plugins.Testing.Tests.Fixtures
{
	...
	public partial class Contact : Entity, INotifyPropertyChanging, INotifyPropertyChanged
    {
		...
		public System.Collections.Generic.IEnumerable<Plugins.Testing.Tests.Fixtures.Account> AccountPrimaryContact
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("account_primary_contact", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("AccountPrimaryContact");
				this.SetRelatedEntities<Plugins.Testing.Tests.Fixtures.Account>("account_primary_contact", null, value);
		...
		public System.Collections.Generic.IEnumerable<Annotation> ContactAnnotation
		{
			[DebuggerNonUserCode]
			get
			{
