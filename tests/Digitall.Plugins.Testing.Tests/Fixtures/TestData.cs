    ...
    public static IEnumerable<Entity> Default
    {
        get
        {
            var CorpA = new Account(Guid.Parse("00000000-0000-0000-0001-000000000001"))
            {
                ...
                AccountCategoryCodeMultiple = [new OptionSetValue(1), new OptionSetValue(2), new OptionSetValue(3)],
            ...
            var CorpB = new Account(Guid.Parse("00000000-0000-0000-0001-000000000002"))
            {
                ...
                AccountCategoryCodeMultiple = new OptionSetValueCollection { new OptionSetValue(3), new OptionSetValue(4), new OptionSetValue(5) },
            };


            var ConA = new Contact(Guid.Parse("00000000-0000-0000-0002-000000000001")) { FirstName = "John A", LastName = " Doe A" };

            var ConB = new Contact(Guid.Parse("00000000-0000-0000-0002-000000000002")) { ParentCustomerId = CorpB.ToNamedEntityReference(), FirstName = "John B", LastName = " Doe B (Corp B)" };

            var ConC = new Contact(Guid.Parse("00000000-0000-0000-0002-000000000003")) { ParentCustomerId = CorpB.ToNamedEntityReference(), FirstName = "John C", LastName = " Doe C (Corp B)" };
