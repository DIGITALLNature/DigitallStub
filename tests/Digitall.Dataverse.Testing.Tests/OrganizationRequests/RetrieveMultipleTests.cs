...
public class RetrieveMultipleTests
{
    ...
    public void QueryExpression_Paging()
    {
        ...
        result = sut.RetrieveMultiple(new QueryExpression(Account.EntityLogicalName)
        {
            ColumnSet = new ColumnSet(true), PageInfo = new PagingInfo { PagingCookie = result.PagingCookie, PageNumber = 2 }
        });
    ...
    public void QueryExpression_EmptyPageOnPaging()
    {
        ...
        result = sut.RetrieveMultiple(new QueryExpression(Account.EntityLogicalName)
        {
            ...
            {
                PagingCookie = result.PagingCookie, PageNumber = 21 // out of range
            }
        });
    ...
    public void QueryExpression_Destinct()
    {
        ...
        var result = sut.RetrieveMultiple(new QueryExpression(Account.EntityLogicalName)
        {
            ...
            Criteria = new FilterExpression { Conditions = { new ConditionExpression(Account.LogicalNames.Name, ConditionOperator.Equal, "B Corp") } },
        ...
        resultDestinct.Entities.Should().ContainSingle();
    }
    ...
    public void QueryExpression_Order()
    {
        ...
        var resultDescending = sut.RetrieveMultiple(new QueryExpression(Account.EntityLogicalName)
        {
            ColumnSet = new ColumnSet(true), Orders = { new OrderExpression(Account.LogicalNames.ExchangeRate, OrderType.Descending) }
        });
        ...
        var resultAscending = sut.RetrieveMultiple(new QueryExpression(Account.EntityLogicalName)
        {
            ColumnSet = new ColumnSet(true), Orders = { new OrderExpression(Account.LogicalNames.ExchangeRate, OrderType.Ascending) }
        });
    ...
    public void QueryByAttribute_Paging()
    {
        ...
        result = sut.RetrieveMultiple(new QueryByAttribute(Account.EntityLogicalName)
        {
            ColumnSet = new ColumnSet(true), PageInfo = new PagingInfo { PagingCookie = result.PagingCookie, PageNumber = 2 }
        });
    ...
    public void QueryByAttribute_Order()
    {
        ...
        var resultDescending = sut.RetrieveMultiple(new QueryByAttribute(Account.EntityLogicalName)
        {
            ColumnSet = new ColumnSet(true), Orders = { new OrderExpression(Account.LogicalNames.ExchangeRate, OrderType.Descending) }
        });
        resultDescending.Should().NotBeNull();
        ...
        var resultAscending = sut.RetrieveMultiple(new QueryByAttribute(Account.EntityLogicalName)
        {
            ColumnSet = new ColumnSet(true), Orders = { new OrderExpression(Account.LogicalNames.ExchangeRate, OrderType.Ascending) }
        });
        resultAscending.Should().NotBeNull();
