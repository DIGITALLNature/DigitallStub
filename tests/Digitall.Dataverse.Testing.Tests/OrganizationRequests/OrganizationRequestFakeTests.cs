...
public class OrganizationRequestFakeTests
{
    ...
    public void CreateFake_Should_CreateRecord()
    {
        ...
        _sut.State.Entities[Account.EntityLogicalName].Should().ContainKey(response.id);
        _sut.State.Entities[Account.EntityLogicalName][response.id].GetAttributeValue<string>("name").Should().Be("Test Account");
    }
    ...
    public void UpdateFake_Should_UpdateRecord()
    {
        ...
        _sut.State.Entities[Account.EntityLogicalName][id].GetAttributeValue<string>("name").Should().Be("New Name");
    }
    ...
    public void DeleteFake_Should_RemoveRecord()
    {
        ...
        _sut.State.Entities[Account.EntityLogicalName].Should().NotContainKey(id);
    }
    ...
    public void RetrieveFake_Should_ReturnRecord()
    {
        ...
        var request = new RetrieveRequest { Target = new EntityReference(Account.EntityLogicalName, id), ColumnSet = new ColumnSet("name") };
    ...
    public void UpsertFake_Should_CreateIfNew()
    {
        ...
        _sut.State.Entities[Account.EntityLogicalName].Should().ContainKey(id);
    }
    ...
    public void UpsertFake_Should_UpdateIfExisting()
    {
        ...
        _sut.State.Entities[Account.EntityLogicalName][id].GetAttributeValue<string>("name").Should().Be("Updated");
    }
    ...
    public void SetStateFake_Should_UpdateStateAndStatus()
    {
        ...
        {
            EntityMoniker = new EntityReference(Account.EntityLogicalName, id), State = new OptionSetValue(1), Status = new OptionSetValue(2)
        };

        _sut.Execute(request);

        var updated = _sut.State.Entities[Account.EntityLogicalName][id];
    ...
    public void AssignRequestFake_Should_UpdateOwner()
    {
        ...
        var request = new AssignRequest { Target = new EntityReference(Account.EntityLogicalName, id), Assignee = userRef };
    ...
    public void ExecuteTransactionFake_Should_ExecuteAllRequests()
    {
        ...
        _sut.State.Entities[Account.EntityLogicalName].Should().HaveCount(2);
    }
    ...
    public void BulkDeleteFake_Should_DeleteRecords()
    {
        ...
        var request = new BulkDeleteRequest
        {
            ...
            [
                new QueryExpression(Account.EntityLogicalName)
                {
                    ...
                    {
                        Conditions = { new ConditionExpression("name", ConditionOperator.Equal, "Delete Me") }
                    }
                }
            ],
            ToRecipients = [],
        ...
        _sut.State.Entities[Account.EntityLogicalName].Should().NotContainKey(id1);
        _sut.State.Entities[Account.EntityLogicalName].Should().ContainKey(id2);
    }
