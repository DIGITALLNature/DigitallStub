...
{
    private static readonly DateTime TestDate = new(2024, 3, 11); // Monday
    ...
    public void ToFirstDayOfDeltaWeek_Should_ReturnFirstDayOfNextWeek()
    {
        ...
        var thisWeek = TestDate.ToFirstDayOfDeltaWeek();
    ...
    {
        var firstDay = TestDate.ToFirstDayOfDeltaWeek();
        var lastDay = TestDate.ToLastDayOfDeltaWeek();
