...
namespace Digitall.Dataverse.Testing.Tests.Fixtures
{
	...
	public partial class Contact : Entity, INotifyPropertyChanging, INotifyPropertyChanged
    {
		...
		public System.Collections.Generic.IEnumerable<Dataverse.Testing.Tests.Fixtures.Account> AccountPrimaryContact
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("account_primary_contact", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("AccountPrimaryContact");
				this.SetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("account_primary_contact", null, value);
