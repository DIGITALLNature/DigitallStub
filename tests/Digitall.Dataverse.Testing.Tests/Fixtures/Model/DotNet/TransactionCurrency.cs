...
namespace Digitall.Dataverse.Testing.Tests.Fixtures
{
	...
	public partial class TransactionCurrency : Entity, INotifyPropertyChanging, INotifyPropertyChanged
    {
		...
		public System.Collections.Generic.IEnumerable<Dataverse.Testing.Tests.Fixtures.Account> TransactioncurrencyAccount
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("transactioncurrency_account", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("TransactioncurrencyAccount");
				this.SetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("transactioncurrency_account", null, value);
