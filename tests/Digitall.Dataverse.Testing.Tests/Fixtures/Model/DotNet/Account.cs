...
namespace Digitall.Dataverse.Testing.Tests.Fixtures
{
	...
	public partial class Account : Entity, INotifyPropertyChanging, INotifyPropertyChanged
    {
		...
		public System.Collections.Generic.IEnumerable<Dataverse.Testing.Tests.Fixtures.Account> AccountMasterAccount
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("account_master_account", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("AccountMasterAccount");
				this.SetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("account_master_account", null, value);
		...
		public System.Collections.Generic.IEnumerable<Dataverse.Testing.Tests.Fixtures.Account> AccountParentAccount
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("account_parent_account", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("AccountParentAccount");
				this.SetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("account_parent_account", null, value);
		...
		public System.Collections.Generic.IEnumerable<Dataverse.Testing.Tests.Fixtures.Account> MsaAccountManagingpartner
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("msa_account_managingpartner", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("MsaAccountManagingpartner");
				this.SetRelatedEntities<Dataverse.Testing.Tests.Fixtures.Account>("msa_account_managingpartner", null, value);
        ...
        public static Dataverse.Testing.Tests.Fixtures.Account Retrieve(IOrganizationService service, Guid id)
        {
            return Retrieve(service,id, new ColumnSet(true));
        }

        public static Dataverse.Testing.Tests.Fixtures.Account Retrieve(IOrganizationService service, Guid id, ColumnSet columnSet)
        {
            return service.Retrieve("account", id, columnSet).ToEntity<Dataverse.Testing.Tests.Fixtures.Account>();
        }

        public Dataverse.Testing.Tests.Fixtures.Account GetChangedEntity()
        {
            if (_trackChanges)
            {
                ...
                return new  Dataverse.Testing.Tests.Fixtures.Account(Id) {Attributes = attr };
            }
            return this;
        }
        #endregion
	...
	{
		public IQueryable<Dataverse.Testing.Tests.Fixtures.Account> AccountSet
		{
			get
			{
				return CreateQuery<Dataverse.Testing.Tests.Fixtures.Account>();
			}
		}
	}
	#endregion
