...
public class QueryTests
{
    ...
    public void GenerateQuery_Equal_string()
    {
        ...
        queryResult.AsEnumerable().Should().NotBeNull();
        queryResult.AsEnumerable().Should().ContainSingle();
    }
    ...
    {
        var query = new QueryExpression(Account.EntityLogicalName);
        query.Criteria.AddCondition(Account.LogicalNames.ParentAccountId, ConditionOperator.NotEqual,
            new EntityReference(Account.EntityLogicalName, Guid.Parse("00000000-0000-0000-0001-000000000001")));
    ...
    public void GenerateQuery_Like_Left()
    {
        ...
        var queryResult = dataverse.CreateQuery<Account>().Where(result);
        queryResult.AsEnumerable().Should().NotBeNull();
        queryResult.AsEnumerable().Should().HaveCount(2);
    }
    ...
    public void GenerateQuery_NotLike_Left()
    {
        ...
        var queryResult = dataverse.CreateQuery<Account>().Where(result);
        queryResult.AsEnumerable().Should().NotBeNull();
        queryResult.AsEnumerable().Should().BeEmpty();
    }
