...
{
        private static bool IsAttributeTrue(this XElement elem, string attributeName)
        {
            var val = elem.GetAttribute(attributeName)?.Value;
            return "true".Equals(val, StringComparison.OrdinalIgnoreCase) || "1".Equals(val, StringComparison.Ordinal);
        }
        ...
        public static object ToValue(this XElement elem, string sEntityName, string sAttributeName, ConditionOperator op)
        {
            return GetConditionExpressionValueCast(elem.Value, sEntityName, sAttributeName, op);
        }
        ...
        public static ConditionExpression ToConditionExpression(this XElement elem)
        {
            ...
            values = elem
                        ...
                        .Select(el => el.ToValue(entityName, attributeName, op))
                        .ToArray();
        ...
        public static object GetConditionExpressionValueCast(string value, string sEntityName, string sAttributeName, ConditionOperator op)
        {
            //Try parsing a guid
